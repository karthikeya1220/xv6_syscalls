...
0000000080000000 <_entry>:
    ...
    80000004:	6c013103          	ld	sp,1728(sp) # 8000b6c0 <_GLOBAL_OFFSET_TABLE_+0x8>
...
0000000080000060 <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    8000006e:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7fe41a7f>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    80000158:	5cc50513          	addi	a0,a0,1484 # 80013720 <cons>
  ...
  while(n > 0){
    ...
    80000164:	5c048493          	addi	s1,s1,1472 # 80013720 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
    ...
    8000016c:	65090913          	addi	s2,s2,1616 # 800137b8 <cons+0x98>
  while(n > 0){
    ...
    800001a4:	58070713          	addi	a4,a4,1408 # 80013720 <cons>
    ...
    800001ee:	53650513          	addi	a0,a0,1334 # 80013720 <cons>
  ...
  return target - n;
    ...
    80000218:	5af72223          	sw	a5,1444(a4) # 800137b8 <cons+0x98>
  ...
  release(&cons.lock);
    ...
    8000022e:	4f650513          	addi	a0,a0,1270 # 80013720 <cons>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    80000282:	4a250513          	addi	a0,a0,1186 # 80013720 <cons>
  ...
  case '\x7f': // Delete key (Backspace)
    if(cons.e != cons.w){
    800002a2:	00013717          	auipc	a4,0x13
    800002a6:	47e70713          	addi	a4,a4,1150 # 80013720 <cons>
    ...
    800002b8:	00013717          	auipc	a4,0x13
    800002bc:	50f72423          	sw	a5,1288(a4) # 800137c0 <cons+0xa0>
      consputc(BACKSPACE);
  ...
  switch(c){
    ...
    if(cons.e != cons.w){
    800002d6:	00013717          	auipc	a4,0x13
    800002da:	44a70713          	addi	a4,a4,1098 # 80013720 <cons>
    ...
    800002ec:	00013717          	auipc	a4,0x13
    800002f0:	4cf72a23          	sw	a5,1236(a4) # 800137c0 <cons+0xa0>
      consputc(BACKSPACE);
    ...
    while(cons.e != cons.w &&
    80000300:	00013717          	auipc	a4,0x13
    80000304:	42070713          	addi	a4,a4,1056 # 80013720 <cons>
    80000308:	0a072783          	lw	a5,160(a4)
    8000030c:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF_SIZE] != '\n'){
    80000310:	00013497          	auipc	s1,0x13
    80000314:	41048493          	addi	s1,s1,1040 # 80013720 <cons>
    while(cons.e != cons.w &&
  ...
  release(&cons.lock);
    ...
    80000356:	3ce50513          	addi	a0,a0,974 # 80013720 <cons>
    ...
    800003a8:	00013717          	auipc	a4,0x13
    800003ac:	37870713          	addi	a4,a4,888 # 80013720 <cons>
    ...
    800003ce:	00013797          	auipc	a5,0x13
    800003d2:	35278793          	addi	a5,a5,850 # 80013720 <cons>
    ...
    800003fc:	00013797          	auipc	a5,0x13
    80000400:	3bc7a783          	lw	a5,956(a5) # 800137b8 <cons+0x98>
    ...
    80000412:	e2fff0ef          	jal	80000240 <consputc>
      cons.buf[cons.e++ % INPUT_BUF_SIZE] = c;
    80000416:	00013797          	auipc	a5,0x13
    8000041a:	30a78793          	addi	a5,a5,778 # 80013720 <cons>
    ...
    80000436:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    8000043a:	00013797          	auipc	a5,0x13
    8000043e:	38c7a123          	sw	a2,898(a5) # 800137bc <cons+0x9c>
        wakeup(&cons.r);
    80000442:	00013517          	auipc	a0,0x13
    80000446:	37650513          	addi	a0,a0,886 # 800137b8 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80000460:	00013517          	auipc	a0,0x13
    80000464:	2c050513          	addi	a0,a0,704 # 80013720 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    80000470:	001bb797          	auipc	a5,0x1bb
    80000474:	77878793          	addi	a5,a5,1912 # 801bbbe8 <devsw>
...
printf(char *fmt, ...)
{
  ...
  locking = pr.locking;
    ...
    80000548:	29c7a783          	lw	a5,668(a5) # 800137e0 <pr+0x18>
  ...
  for(i = 0; (cx = fmt[i] & 0xff) != 0; i++){
    ...
    80000594:	23850513          	addi	a0,a0,568 # 800137c8 <pr>
  ...
  return 0;
    ...
    release(&pr.lock);
    800007ea:	00013517          	auipc	a0,0x13
    800007ee:	fde50513          	addi	a0,a0,-34 # 800137c8 <pr>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    80000804:	00013797          	auipc	a5,0x13
    80000808:	fc07ae23          	sw	zero,-36(a5) # 800137e0 <pr+0x18>
  printf("panic: ");
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    80000828:	0000b717          	auipc	a4,0xb
    8000082c:	eaf72c23          	sw	a5,-328(a4) # 8000b6e0 <panicked>
  for(;;)
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    8000083c:	00013497          	auipc	s1,0x13
    80000840:	f8c48493          	addi	s1,s1,-116 # 800137c8 <pr>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    800008a4:	00013517          	auipc	a0,0x13
    800008a8:	f4450513          	addi	a0,a0,-188 # 800137e8 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    800008c8:	0000b797          	auipc	a5,0xb
    800008cc:	e187a783          	lw	a5,-488(a5) # 8000b6e0 <panicked>
...
uartstart()
{
  while(1){
    ...
    800008fe:	0000b797          	auipc	a5,0xb
    80000902:	dea7b783          	ld	a5,-534(a5) # 8000b6e8 <uart_tx_r>
    80000906:	0000b717          	auipc	a4,0xb
    8000090a:	dea73703          	ld	a4,-534(a4) # 8000b6f0 <uart_tx_w>
    8000090e:	08f70263          	beq	a4,a5,80000992 <uartstart+0x94>
{
    ...
    8000092c:	00013a97          	auipc	s5,0x13
    80000930:	ebca8a93          	addi	s5,s5,-324 # 800137e8 <uart_tx_lock>
    uart_tx_r += 1;
    80000934:	0000b497          	auipc	s1,0xb
    80000938:	db448493          	addi	s1,s1,-588 # 8000b6e8 <uart_tx_r>
    ...
    if(uart_tx_w == uart_tx_r){
    80000940:	0000b997          	auipc	s3,0xb
    80000944:	db098993          	addi	s3,s3,-592 # 8000b6f0 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
...
000000008000099e <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    800009b0:	00013517          	auipc	a0,0x13
    800009b4:	e3850513          	addi	a0,a0,-456 # 800137e8 <uart_tx_lock>
    800009b8:	2a0000ef          	jal	80000c58 <acquire>
  if(panicked){
    800009bc:	0000b797          	auipc	a5,0xb
    800009c0:	d247a783          	lw	a5,-732(a5) # 8000b6e0 <panicked>
    800009c4:	efbd                	bnez	a5,80000a42 <uartputc+0xa4>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    800009c6:	0000b717          	auipc	a4,0xb
    800009ca:	d2a73703          	ld	a4,-726(a4) # 8000b6f0 <uart_tx_w>
    800009ce:	0000b797          	auipc	a5,0xb
    800009d2:	d1a7b783          	ld	a5,-742(a5) # 8000b6e8 <uart_tx_r>
    800009d6:	02078793          	addi	a5,a5,32
    sleep(&uart_tx_r, &uart_tx_lock);
    800009da:	00013997          	auipc	s3,0x13
    800009de:	e0e98993          	addi	s3,s3,-498 # 800137e8 <uart_tx_lock>
    800009e2:	0000b497          	auipc	s1,0xb
    800009e6:	d0648493          	addi	s1,s1,-762 # 8000b6e8 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    800009ea:	0000b917          	auipc	s2,0xb
    800009ee:	d0690913          	addi	s2,s2,-762 # 8000b6f0 <uart_tx_w>
  ...
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    80000a0c:	00013497          	auipc	s1,0x13
    80000a10:	ddc48493          	addi	s1,s1,-548 # 800137e8 <uart_tx_lock>
    80000a14:	01f77793          	andi	a5,a4,31
    80000a18:	97a6                	add	a5,a5,s1
    80000a1a:	01478c23          	sb	s4,24(a5)
  uart_tx_w += 1;
    80000a1e:	0705                	addi	a4,a4,1
    80000a20:	0000b797          	auipc	a5,0xb
    80000a24:	cce7b823          	sd	a4,-816(a5) # 8000b6f0 <uart_tx_w>
  uartstart();
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    80000a84:	00013497          	auipc	s1,0x13
    80000a88:	d6448493          	addi	s1,s1,-668 # 800137e8 <uart_tx_lock>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000aba:	001bc797          	auipc	a5,0x1bc
    80000abe:	2c678793          	addi	a5,a5,710 # 801bcd80 <end>
  ...
  acquire(&kmem.lock);
    80000ad6:	00013917          	auipc	s2,0x13
    80000ada:	d4a90913          	addi	s2,s2,-694 # 80013820 <kmem>
...
0000000080000b54 <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    80000b64:	00013517          	auipc	a0,0x13
    80000b68:	cbc50513          	addi	a0,a0,-836 # 80013820 <kmem>
    80000b6c:	06c000ef          	jal	80000bd8 <initlock>
  freerange(end, (void*)PHYSTOP);
    80000b70:	45c5                	li	a1,17
    80000b72:	05ee                	slli	a1,a1,0x1b
    80000b74:	001bc517          	auipc	a0,0x1bc
    80000b78:	20c50513          	addi	a0,a0,524 # 801bcd80 <end>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    80000b92:	00013497          	auipc	s1,0x13
    80000b96:	c8e48493          	addi	s1,s1,-882 # 80013820 <kmem>
  ...
  if(r)
    ...
    80000ba6:	00013517          	auipc	a0,0x13
    80000baa:	c7a50513          	addi	a0,a0,-902 # 80013820 <kmem>
  ...
  return (void*)r;
    ...
    80000bc8:	8082                	ret
  release(&kmem.lock);
    80000bca:	00013517          	auipc	a0,0x13
    80000bce:	c5650513          	addi	a0,a0,-938 # 80013820 <kmem>
    ...
    80000d98:	00c587b3          	add	a5,a1,a2
{
    ...
    80000da0:	0705                	addi	a4,a4,1 # fffffffffffff001 <end+0xffffffff7fe42281>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    while(started == 0)
    80000ed2:	0000b717          	auipc	a4,0xb
    80000ed6:	82670713          	addi	a4,a4,-2010 # 8000b6f8 <started>
  if(cpuid() == 0){
  ...
  scheduler();        
    ...
    __sync_synchronize();
    80000f68:	0330000f          	fence	rw,rw
    started = 1;
    80000f6c:	4785                	li	a5,1
    80000f6e:	0000a717          	auipc	a4,0xa
    80000f72:	78f72523          	sw	a5,1930(a4) # 8000b6f8 <started>
...
msginit(void)
{
    ...
    80000f90:	00013517          	auipc	a0,0x13
    80000f94:	8b050513          	addi	a0,a0,-1872 # 80013840 <msgtable>
    80000f98:	c41ff0ef          	jal	80000bd8 <initlock>
    for(int i = 0; i < MSG_MAX_QUEUES; i++) {
    80000f9c:	00013497          	auipc	s1,0x13
    80000fa0:	8d448493          	addi	s1,s1,-1836 # 80013870 <msgtable+0x30>
    80000fa4:	00013a17          	auipc	s4,0x13
    80000fa8:	bcca0a13          	addi	s4,s4,-1076 # 80013b70 <msgtable+0x330>
...
sys_msgget(void)
{
  ...
  acquire(&msgtable.lock);
    80001014:	00013517          	auipc	a0,0x13
    80001018:	82c50513          	addi	a0,a0,-2004 # 80013840 <msgtable>
    8000101c:	c3dff0ef          	jal	80000c58 <acquire>
  for(int i = 0; i < MSG_MAX_QUEUES; i++) {
    80001020:	00013797          	auipc	a5,0x13
    80001024:	83878793          	addi	a5,a5,-1992 # 80013858 <msgtable+0x18>
  ...
  release(&msgtable.lock);
    8000103a:	00013517          	auipc	a0,0x13
    8000103e:	80650513          	addi	a0,a0,-2042 # 80013840 <msgtable>
  ...
  return -1;
    ...
    80001058:	7ec50513          	addi	a0,a0,2028 # 80013840 <msgtable>
...
sys_msgsnd(void)
{
  ...
  if(msqid < 0 || msqid >= MSG_MAX_QUEUES || !msgtable.queues[msqid].in_use)
    ...
    800010d6:	00012717          	auipc	a4,0x12
    800010da:	76a70713          	addi	a4,a4,1898 # 80013840 <msgtable>
  ...
  acquire(&msgtable.queues[msqid].lock);
    ...
    80001122:	00012497          	auipc	s1,0x12
    80001126:	71e48493          	addi	s1,s1,1822 # 80013840 <msgtable>
  ...
  if(msgtable.queues[msqid].msg_count >= msgtable.queues[msqid].queue_size) {
    ...
    8000114a:	00012497          	auipc	s1,0x12
    8000114e:	6f648493          	addi	s1,s1,1782 # 80013840 <msgtable>
    if(flags & IPC_NOWAIT) {
  ...
  int msg_index = msqid * MSG_MAX_SIZE + msgtable.queues[msqid].last_msg;
    ...
    8000118a:	00012797          	auipc	a5,0x12
    8000118e:	6b678793          	addi	a5,a5,1718 # 80013840 <msgtable>
  ...
  msgtable.queues[msqid].last_msg = (msgtable.queues[msqid].last_msg + 1) % MSG_MAX_SIZE;
    800011e2:	00012497          	auipc	s1,0x12
    800011e6:	65e48493          	addi	s1,s1,1630 # 80013840 <msgtable>
...
sys_msgrcv(void)
{
  ...
  if(msqid < 0 || msqid >= MSG_MAX_QUEUES || !msgtable.queues[msqid].in_use)
    ...
    800012da:	00012697          	auipc	a3,0x12
    800012de:	56668693          	addi	a3,a3,1382 # 80013840 <msgtable>
  ...
  acquire(&msgtable.queues[msqid].lock);
    ...
    80001304:	00012497          	auipc	s1,0x12
    80001308:	53c48493          	addi	s1,s1,1340 # 80013840 <msgtable>
  ...
  if(msgtable.queues[msqid].msg_count == 0) {
    ...
    8000133c:	00012517          	auipc	a0,0x12
    80001340:	50450513          	addi	a0,a0,1284 # 80013840 <msgtable>
    ...
    8000135c:	00012517          	auipc	a0,0x12
    80001360:	4e450513          	addi	a0,a0,1252 # 80013840 <msgtable>
  ...
  int msg_index = msqid * 100 + msgtable.queues[msqid].first_msg;
    ...
    80001378:	00012617          	auipc	a2,0x12
    8000137c:	4c860613          	addi	a2,a2,1224 # 80013840 <msgtable>
  ...
  if(msgtyp > 0 && msg->mtype != msgtyp) {
    ...
    800013ae:	00012697          	auipc	a3,0x12
    800013b2:	49268693          	addi	a3,a3,1170 # 80013840 <msgtable>
  ...
  msgtable.queues[msqid].first_msg = (msgtable.queues[msqid].first_msg + 1) % 100;
    ...
    800013dc:	00012517          	auipc	a0,0x12
    800013e0:	46450513          	addi	a0,a0,1124 # 80013840 <msgtable>
  ...
  return msgsz;
    ...
    80001440:	00012517          	auipc	a0,0x12
    80001444:	40050513          	addi	a0,a0,1024 # 80013840 <msgtable>
...
sys_msgctl(void)
{
    ...
    800014b6:	00012797          	auipc	a5,0x12
    800014ba:	38a78793          	addi	a5,a5,906 # 80013840 <msgtable>
    ...
    800014f0:	00012717          	auipc	a4,0x12
    800014f4:	35070713          	addi	a4,a4,848 # 80013840 <msgtable>
    ...
    80001502:	00012697          	auipc	a3,0x12
    80001506:	33e68693          	addi	a3,a3,830 # 80013840 <msgtable>
    ...
    8000157a:	00012717          	auipc	a4,0x12
    8000157e:	2c670713          	addi	a4,a4,710 # 80013840 <msgtable>
    ...
    800015aa:	00012717          	auipc	a4,0x12
    800015ae:	29670713          	addi	a4,a4,662 # 80013840 <msgtable>
    ...
    800015e0:	00012717          	auipc	a4,0x12
    800015e4:	26070713          	addi	a4,a4,608 # 80013840 <msgtable>
    800015e8:	97ba                	add	a5,a5,a4
    800015ea:	4f9c                	lw	a5,24(a5)
    800015ec:	cb95                	beqz	a5,80001620 <sys_msgctl+0x1c0>
            queue->in_use = 0;
    800015ee:	00012697          	auipc	a3,0x12
    800015f2:	25268693          	addi	a3,a3,594 # 80013840 <msgtable>
...
sfence_vma()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    80001648:	0000a797          	auipc	a5,0xa
    8000164c:	0b87b783          	ld	a5,184(a5) # 8000b700 <kernel_pagetable>
...
00000000800018c8 <kvminit>:
{
  ...
  kernel_pagetable = kvmmake();
    ...
    800018d8:	e2a7b623          	sd	a0,-468(a5) # 8000b700 <kernel_pagetable>
}
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80001ea6:	001a5497          	auipc	s1,0x1a5
    80001eaa:	2e248493          	addi	s1,s1,738 # 801a7188 <proc>
    char *pa = kalloc();
    if(pa == 0)
      panic("kalloc");
    ...
    80001eb4:	f3d90913          	addi	s2,s2,-195 # fffffffffcf3cf3d <end+0xffffffff7cd801bd>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80001ed2:	001b0a97          	auipc	s5,0x1b0
    80001ed6:	ab6a8a93          	addi	s5,s5,-1354 # 801b1988 <proc_lock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80001f46:	001a5517          	auipc	a0,0x1a5
    80001f4a:	e1250513          	addi	a0,a0,-494 # 801a6d58 <pid_lock>
  ...
  initlock(&wait_lock, "wait_lock");
    ...
    80001f5a:	001a5517          	auipc	a0,0x1a5
    80001f5e:	e1650513          	addi	a0,a0,-490 # 801a6d70 <wait_lock>
    80001f62:	c77fe0ef          	jal	80000bd8 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
    80001f66:	001a5497          	auipc	s1,0x1a5
    80001f6a:	49a48493          	addi	s1,s1,1178 # 801a7400 <proc+0x278>
    80001f6e:	001a5917          	auipc	s2,0x1a5
    80001f72:	21a90913          	addi	s2,s2,538 # 801a7188 <proc>
    ...
    80001f84:	f3d98993          	addi	s3,s3,-195 # fffffffffcf3cf3d <end+0xffffffff7cd801bd>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80001fa2:	001b0a97          	auipc	s5,0x1b0
    80001fa6:	9e6a8a93          	addi	s5,s5,-1562 # 801b1988 <proc_lock>
...
mycpu(void)
{
  ...
  return c;
    ...
    8000201e:	001a5517          	auipc	a0,0x1a5
    80002022:	d6a50513          	addi	a0,a0,-662 # 801a6d88 <cpus>
...
myproc(void)
{
  ...
  struct proc *p = c->proc;
    ...
    80002042:	001a5717          	auipc	a4,0x1a5
    80002046:	d1670713          	addi	a4,a4,-746 # 801a6d58 <pid_lock>
...
forkret(void)
{
  ...
  if (first) {
    8000206e:	00009797          	auipc	a5,0x9
    80002072:	6027a783          	lw	a5,1538(a5) # 8000b670 <first.1>
  ...
  usertrapret();
    ...
    first = 0;
    8000208a:	00009797          	auipc	a5,0x9
    8000208e:	5e07a323          	sw	zero,1510(a5) # 8000b670 <first.1>
    __sync_synchronize();
    80002092:	0330000f          	fence	rw,rw
...
0000000080002098 <allocpid>:
{
  ...
  acquire(&pid_lock);
    800020a4:	001a5917          	auipc	s2,0x1a5
    800020a8:	cb490913          	addi	s2,s2,-844 # 801a6d58 <pid_lock>
    800020ac:	854a                	mv	a0,s2
    800020ae:	babfe0ef          	jal	80000c58 <acquire>
  pid = nextpid;
    800020b2:	00009797          	auipc	a5,0x9
    800020b6:	5c278793          	addi	a5,a5,1474 # 8000b674 <nextpid>
...
000000008000220c <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80002218:	001a5497          	auipc	s1,0x1a5
    8000221c:	f7048493          	addi	s1,s1,-144 # 801a7188 <proc>
    80002220:	001af917          	auipc	s2,0x1af
    80002224:	76890913          	addi	s2,s2,1896 # 801b1988 <proc_lock>
    acquire(&p->lock);
...
00000000800022b2 <userinit>:
{
  ...
  initproc = p;
    800022c2:	00009797          	auipc	a5,0x9
    800022c6:	44a7b323          	sd	a0,1094(a5) # 8000b708 <initproc>
  uvmfirst(p->pagetable, initcode, sizeof(initcode));
    800022ca:	03400613          	li	a2,52
    800022ce:	00009597          	auipc	a1,0x9
    800022d2:	3b258593          	addi	a1,a1,946 # 8000b680 <initcode>
...
0000000080002370 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
    8000243c:	001a5497          	auipc	s1,0x1a5
    80002440:	93448493          	addi	s1,s1,-1740 # 801a6d70 <wait_lock>
...
000000008000247e <scheduler>:
{
  ...
  c->proc = 0;
    ...
    8000249e:	001a5717          	auipc	a4,0x1a5
    800024a2:	8ba70713          	addi	a4,a4,-1862 # 801a6d58 <pid_lock>
    800024a6:	975a                	add	a4,a4,s6
    800024a8:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    800024ac:	001a5717          	auipc	a4,0x1a5
    800024b0:	8e470713          	addi	a4,a4,-1820 # 801a6d90 <cpus+0x8>
    800024b4:	9b3a                	add	s6,s6,a4
        p->state = RUNNING;
    800024b6:	4c11                	li	s8,4
        c->proc = p;
    800024b8:	079e                	slli	a5,a5,0x7
    800024ba:	001a5a17          	auipc	s4,0x1a5
    800024be:	89ea0a13          	addi	s4,s4,-1890 # 801a6d58 <pid_lock>
    800024c2:	9a3e                	add	s4,s4,a5
        found = 1;
    800024c4:	4b85                	li	s7,1
    for(p = proc; p < &proc[NPROC]; p++) {
    800024c6:	001af997          	auipc	s3,0x1af
    800024ca:	4c298993          	addi	s3,s3,1218 # 801b1988 <proc_lock>
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    for(p = proc; p < &proc[NPROC]; p++) {
    80002526:	001a5497          	auipc	s1,0x1a5
    8000252a:	c6248493          	addi	s1,s1,-926 # 801a7188 <proc>
      if(p->state == RUNNABLE) {
...
0000000080002532 <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    80002552:	001a5717          	auipc	a4,0x1a5
    80002556:	80670713          	addi	a4,a4,-2042 # 801a6d58 <pid_lock>
  ...
  intena = mycpu()->intena;
    80002578:	001a4917          	auipc	s2,0x1a4
    8000257c:	7e090913          	addi	s2,s2,2016 # 801a6d58 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    80002590:	001a5597          	auipc	a1,0x1a5
    80002594:	80058593          	addi	a1,a1,-2048 # 801a6d90 <cpus+0x8>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80002678:	001a5497          	auipc	s1,0x1a5
    8000267c:	b1048493          	addi	s1,s1,-1264 # 801a7188 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80002684:	001af917          	auipc	s2,0x1af
    80002688:	30490913          	addi	s2,s2,772 # 801b1988 <proc_lock>
...
00000000800026ce <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    800026e0:	001a5497          	auipc	s1,0x1a5
    800026e4:	aa848493          	addi	s1,s1,-1368 # 801a7188 <proc>
      pp->parent = initproc;
    800026e8:	00009a17          	auipc	s4,0x9
    800026ec:	020a0a13          	addi	s4,s4,32 # 8000b708 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    800026f0:	001af997          	auipc	s3,0x1af
    800026f4:	29898993          	addi	s3,s3,664 # 801b1988 <proc_lock>
...
0000000080002724 <exit>:
{
  ...
  if(p == initproc)
    ...
    80002740:	fcc7b783          	ld	a5,-52(a5) # 8000b708 <initproc>
  ...
  acquire(&wait_lock);
    80002784:	001a4497          	auipc	s1,0x1a4
    80002788:	5ec48493          	addi	s1,s1,1516 # 801a6d70 <wait_lock>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    800027d6:	001a5497          	auipc	s1,0x1a5
    800027da:	9b248493          	addi	s1,s1,-1614 # 801a7188 <proc>
    800027de:	001af997          	auipc	s3,0x1af
    800027e2:	1aa98993          	addi	s3,s3,426 # 801b1988 <proc_lock>
    acquire(&p->lock);
...
000000008000287a <wait>:
{
  ...
  acquire(&wait_lock);
    8000289a:	001a4517          	auipc	a0,0x1a4
    8000289e:	4d650513          	addi	a0,a0,1238 # 801a6d70 <wait_lock>
    ...
    for(pp = proc; pp < &proc[NPROC]; pp++){
    800028ac:	001af997          	auipc	s3,0x1af
    800028b0:	0dc98993          	addi	s3,s3,220 # 801b1988 <proc_lock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    800028b4:	001a4c17          	auipc	s8,0x1a4
    800028b8:	4bcc0c13          	addi	s8,s8,1212 # 801a6d70 <wait_lock>
    ...
    800028e2:	c0efe0ef          	jal	80000cf0 <release>
          release(&wait_lock);
    800028e6:	001a4517          	auipc	a0,0x1a4
    800028ea:	48a50513          	addi	a0,a0,1162 # 801a6d70 <wait_lock>
    ...
    8000290e:	be2fe0ef          	jal	80000cf0 <release>
            release(&wait_lock);
    80002912:	001a4517          	auipc	a0,0x1a4
    80002916:	45e50513          	addi	a0,a0,1118 # 801a6d70 <wait_lock>
    ...
    for(pp = proc; pp < &proc[NPROC]; pp++){
    8000295a:	001a5497          	auipc	s1,0x1a5
    8000295e:	82e48493          	addi	s1,s1,-2002 # 801a7188 <proc>
    80002962:	b7e1                	j	8000292a <wait+0xb0>
      release(&wait_lock);
    80002964:	001a4517          	auipc	a0,0x1a4
    80002968:	40c50513          	addi	a0,a0,1036 # 801a6d70 <wait_lock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    80002a2a:	001a5497          	auipc	s1,0x1a5
    80002a2e:	8be48493          	addi	s1,s1,-1858 # 801a72e8 <proc+0x160>
    80002a32:	001af917          	auipc	s2,0x1af
    80002a36:	0b690913          	addi	s2,s2,182 # 801b1ae8 <bcache+0x130>
    if(p->state == UNUSED)
      continue;
...
int thread_join(uint64 *retval) {
    ...
    for(pp = proc; pp < &proc[NPROC]; pp++) {
    80002b2c:	001a4497          	auipc	s1,0x1a4
    80002b30:	65c48493          	addi	s1,s1,1628 # 801a7188 <proc>
    ...
    for(pp = proc; pp < &proc[NPROC]; pp++) {
    80002b36:	001af997          	auipc	s3,0x1af
    80002b3a:	e5298993          	addi	s3,s3,-430 # 801b1988 <proc_lock>
...
struct proc* allocthread(struct proc* parent) {
    ...
    for(p = proc; p < &proc[NPROC]; p++) {
    80002bbc:	001a4497          	auipc	s1,0x1a4
    80002bc0:	5cc48493          	addi	s1,s1,1484 # 801a7188 <proc>
    80002bc4:	001af917          	auipc	s2,0x1af
    80002bc8:	dc490913          	addi	s2,s2,-572 # 801b1988 <proc_lock>
        acquire(&p->lock);
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80002dac:	001af517          	auipc	a0,0x1af
    80002db0:	bf450513          	addi	a0,a0,-1036 # 801b19a0 <tickslock>
...
clockintr()
{
  ...
  asm volatile("csrw 0x14d, %0" : : "r" (x));
    ...
    acquire(&tickslock);
    80002e94:	001af497          	auipc	s1,0x1af
    80002e98:	b0c48493          	addi	s1,s1,-1268 # 801b19a0 <tickslock>
    80002e9c:	8526                	mv	a0,s1
    80002e9e:	dbbfd0ef          	jal	80000c58 <acquire>
    ticks++;
    80002ea2:	00009517          	auipc	a0,0x9
    80002ea6:	86e50513          	addi	a0,a0,-1938 # 8000b710 <ticks>
...
sys_sleep(void)
{
  ...
  if(n < 0)
    ...
    n = 0;
  acquire(&tickslock);
    80003326:	001ae517          	auipc	a0,0x1ae
    8000332a:	67a50513          	addi	a0,a0,1658 # 801b19a0 <tickslock>
    8000332e:	92bfd0ef          	jal	80000c58 <acquire>
  ticks0 = ticks;
    80003332:	00008917          	auipc	s2,0x8
    80003336:	3de92903          	lw	s2,990(s2) # 8000b710 <ticks>
  while(ticks - ticks0 < n){
    ...
    80003344:	001ae997          	auipc	s3,0x1ae
    80003348:	65c98993          	addi	s3,s3,1628 # 801b19a0 <tickslock>
    8000334c:	00008497          	auipc	s1,0x8
    80003350:	3c448493          	addi	s1,s1,964 # 8000b710 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    80003378:	001ae517          	auipc	a0,0x1ae
    8000337c:	62850513          	addi	a0,a0,1576 # 801b19a0 <tickslock>
  ...
  return 0;
    ...
    80003394:	bf49                	j	80003326 <sys_sleep+0x1c>
      release(&tickslock);
    80003396:	001ae517          	auipc	a0,0x1ae
    8000339a:	60a50513          	addi	a0,a0,1546 # 801b19a0 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    800033d6:	001ae517          	auipc	a0,0x1ae
    800033da:	5ca50513          	addi	a0,a0,1482 # 801b19a0 <tickslock>
    800033de:	87bfd0ef          	jal	80000c58 <acquire>
  xticks = ticks;
    800033e2:	00008497          	auipc	s1,0x8
    800033e6:	32e4a483          	lw	s1,814(s1) # 8000b710 <ticks>
  release(&tickslock);
    800033ea:	001ae517          	auipc	a0,0x1ae
    800033ee:	5b650513          	addi	a0,a0,1462 # 801b19a0 <tickslock>
...
sys_cps(void)
{
    ...
    8000342a:	001a4497          	auipc	s1,0x1a4
    8000342e:	ebe48493          	addi	s1,s1,-322 # 801a72e8 <proc+0x160>
    80003432:	001ae997          	auipc	s3,0x1ae
    80003436:	6b698993          	addi	s3,s3,1718 # 801b1ae8 <bcache+0x130>
    {
        if(p->state == SLEEPING)
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    800035c8:	001ae517          	auipc	a0,0x1ae
    800035cc:	3f050513          	addi	a0,a0,1008 # 801b19b8 <bcache>
    800035d0:	e08fd0ef          	jal	80000bd8 <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    800035d4:	001b6797          	auipc	a5,0x1b6
    800035d8:	3e478793          	addi	a5,a5,996 # 801b99b8 <bcache+0x8000>
    800035dc:	001b6717          	auipc	a4,0x1b6
    800035e0:	64470713          	addi	a4,a4,1604 # 801b9c20 <bcache+0x8268>
    800035e4:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    800035e8:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    800035ec:	001ae497          	auipc	s1,0x1ae
    800035f0:	3e448493          	addi	s1,s1,996 # 801b19d0 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    80003648:	001ae517          	auipc	a0,0x1ae
    8000364c:	37050513          	addi	a0,a0,880 # 801b19b8 <bcache>
    80003650:	e08fd0ef          	jal	80000c58 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80003654:	001b6497          	auipc	s1,0x1b6
    80003658:	61c4b483          	ld	s1,1564(s1) # 801b9c70 <bcache+0x82b8>
    8000365c:	001b6797          	auipc	a5,0x1b6
    80003660:	5c478793          	addi	a5,a5,1476 # 801b9c20 <bcache+0x8268>
    ...
    80003682:	c0bc                	sw	a5,64(s1)
      release(&bcache.lock);
    80003684:	001ae517          	auipc	a0,0x1ae
    80003688:	33450513          	addi	a0,a0,820 # 801b19b8 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    8000369a:	001b6497          	auipc	s1,0x1b6
    8000369e:	5ce4b483          	ld	s1,1486(s1) # 801b9c68 <bcache+0x82b0>
    800036a2:	001b6797          	auipc	a5,0x1b6
    800036a6:	57e78793          	addi	a5,a5,1406 # 801b9c20 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    800036d4:	c0bc                	sw	a5,64(s1)
      release(&bcache.lock);
    800036d6:	001ae517          	auipc	a0,0x1ae
    800036da:	2e250513          	addi	a0,a0,738 # 801b19b8 <bcache>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    8000375e:	001ae517          	auipc	a0,0x1ae
    80003762:	25a50513          	addi	a0,a0,602 # 801b19b8 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    b->next = bcache.head.next;
    80003780:	001b6797          	auipc	a5,0x1b6
    80003784:	23878793          	addi	a5,a5,568 # 801b99b8 <bcache+0x8000>
    80003788:	2b87b703          	ld	a4,696(a5)
    8000378c:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    8000378e:	001b6717          	auipc	a4,0x1b6
    80003792:	49270713          	addi	a4,a4,1170 # 801b9c20 <bcache+0x8268>
  ...
  release(&bcache.lock);
    800037a2:	001ae517          	auipc	a0,0x1ae
    800037a6:	21650513          	addi	a0,a0,534 # 801b19b8 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    800037d2:	001ae517          	auipc	a0,0x1ae
    800037d6:	1e650513          	addi	a0,a0,486 # 801b19b8 <bcache>
  ...
  release(&bcache.lock);
    800037e4:	001ae517          	auipc	a0,0x1ae
    800037e8:	1d450513          	addi	a0,a0,468 # 801b19b8 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    80003806:	001ae517          	auipc	a0,0x1ae
    8000380a:	1b250513          	addi	a0,a0,434 # 801b19b8 <bcache>
  ...
  release(&bcache.lock);
    80003818:	001ae517          	auipc	a0,0x1ae
    8000381c:	1a050513          	addi	a0,a0,416 # 801b19b8 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80003840:	001b7797          	auipc	a5,0x1b7
    80003844:	8547a783          	lw	a5,-1964(a5) # 801ba094 <sb+0x1c>
...
000000008000389a <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    800038a4:	001b6797          	auipc	a5,0x1b6
    800038a8:	7d87a783          	lw	a5,2008(a5) # 801ba07c <sb+0x4>
    ...
    bp = bread(dev, BBLOCK(b, sb));
    800038c4:	001b6b17          	auipc	s6,0x1b6
    800038c8:	7b4b0b13          	addi	s6,s6,1972 # 801ba078 <sb>
...
0000000080003a8e <iget>:
{
  ...
  acquire(&itable.lock);
    80003aa2:	001b6517          	auipc	a0,0x1b6
    80003aa6:	5f650513          	addi	a0,a0,1526 # 801ba098 <itable>
    80003aaa:	9aefd0ef          	jal	80000c58 <acquire>
  empty = 0;
    80003aae:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80003ab0:	001b6497          	auipc	s1,0x1b6
    80003ab4:	60048493          	addi	s1,s1,1536 # 801ba0b0 <itable+0x18>
    80003ab8:	001b8697          	auipc	a3,0x1b8
    80003abc:	08868693          	addi	a3,a3,136 # 801bbb40 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003ae2:	c49c                	sw	a5,8(s1)
      release(&itable.lock);
    80003ae4:	001b6517          	auipc	a0,0x1b6
    80003ae8:	5b450513          	addi	a0,a0,1460 # 801ba098 <itable>
  ...
  release(&itable.lock);
    80003b10:	001b6517          	auipc	a0,0x1b6
    80003b14:	58850513          	addi	a0,a0,1416 # 801ba098 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    80003b52:	001b6997          	auipc	s3,0x1b6
    80003b56:	52698993          	addi	s3,s3,1318 # 801ba078 <sb>
  ...
  initlog(dev, &sb);
    80003b7e:	001b6597          	auipc	a1,0x1b6
    80003b82:	4fa58593          	addi	a1,a1,1274 # 801ba078 <sb>
...
0000000080003ba6 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003bbc:	001b6517          	auipc	a0,0x1b6
    80003bc0:	4dc50513          	addi	a0,a0,1244 # 801ba098 <itable>
    80003bc4:	814fd0ef          	jal	80000bd8 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003bc8:	001b6497          	auipc	s1,0x1b6
    80003bcc:	4f848493          	addi	s1,s1,1272 # 801ba0c0 <itable+0x28>
    80003bd0:	001b8997          	auipc	s3,0x1b8
    80003bd4:	f8098993          	addi	s3,s3,-128 # 801bbb50 <log+0x10>
...
0000000080003bfe <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    80003c06:	001b6717          	auipc	a4,0x1b6
    80003c0a:	47e72703          	lw	a4,1150(a4) # 801ba084 <sb+0xc>
    ...
    80003c26:	001b6a17          	auipc	s4,0x1b6
    80003c2a:	452a0a13          	addi	s4,s4,1106 # 801ba078 <sb>
...
0000000080003cba <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003cce:	001b6597          	auipc	a1,0x1b6
    80003cd2:	3c25a583          	lw	a1,962(a1) # 801ba090 <sb+0x18>
...
0000000080003d38 <idup>:
{
  ...
  acquire(&itable.lock);
    80003d44:	001b6517          	auipc	a0,0x1b6
    80003d48:	35450513          	addi	a0,a0,852 # 801ba098 <itable>
  ...
  release(&itable.lock);
    80003d56:	001b6517          	auipc	a0,0x1b6
    80003d5a:	34250513          	addi	a0,a0,834 # 801ba098 <itable>
...
0000000080003d6e <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003dac:	001b6597          	auipc	a1,0x1b6
    80003db0:	2e45a583          	lw	a1,740(a1) # 801ba090 <sb+0x18>
...
0000000080003ef0 <iput>:
{
  ...
  acquire(&itable.lock);
    80003efc:	001b6517          	auipc	a0,0x1b6
    80003f00:	19c50513          	addi	a0,a0,412 # 801ba098 <itable>
  ...
  release(&itable.lock);
    80003f16:	001b6517          	auipc	a0,0x1b6
    80003f1a:	18250513          	addi	a0,a0,386 # 801ba098 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    release(&itable.lock);
    80003f42:	001b6517          	auipc	a0,0x1b6
    80003f46:	15650513          	addi	a0,a0,342 # 801ba098 <itable>
    ...
    acquire(&itable.lock);
    80003f68:	001b6517          	auipc	a0,0x1b6
    80003f6c:	13050513          	addi	a0,a0,304 # 801ba098 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    80004486:	001b7917          	auipc	s2,0x1b7
    8000448a:	6ba90913          	addi	s2,s2,1722 # 801bbb40 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800044a6:	001b7717          	auipc	a4,0x1b7
    800044aa:	6ca70713          	addi	a4,a4,1738 # 801bbb70 <log+0x30>
...
00000000800044d8 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    800044d8:	001b7797          	auipc	a5,0x1b7
    800044dc:	6947a783          	lw	a5,1684(a5) # 801bbb6c <log+0x2c>
    800044e0:	08f05f63          	blez	a5,8000457e <install_trans+0xa6>
{
    ...
    800044fa:	001b7a97          	auipc	s5,0x1b7
    800044fe:	676a8a93          	addi	s5,s5,1654 # 801bbb70 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80004502:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80004504:	001b7997          	auipc	s3,0x1b7
    80004508:	63c98993          	addi	s3,s3,1596 # 801bbb40 <log>
...
0000000080004580 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    80004592:	001b7497          	auipc	s1,0x1b7
    80004596:	5ae48493          	addi	s1,s1,1454 # 801bbb40 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800045c8:	001b7717          	auipc	a4,0x1b7
    800045cc:	5a870713          	addi	a4,a4,1448 # 801bbb70 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    800045ea:	001b7797          	auipc	a5,0x1b7
    800045ee:	5807a123          	sw	zero,1410(a5) # 801bbb6c <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    80004610:	001b7517          	auipc	a0,0x1b7
    80004614:	53050513          	addi	a0,a0,1328 # 801bbb40 <log>
    80004618:	e40fc0ef          	jal	80000c58 <acquire>
  while(1){
    if(log.committing){
    8000461c:	001b7497          	auipc	s1,0x1b7
    80004620:	52448493          	addi	s1,s1,1316 # 801bbb40 <log>
      sleep(&log, &log.lock);
    ...
    80004652:	bff9                	j	80004630 <begin_op+0x2c>
      ...
      log.outstanding += 1;
    80004654:	001b7517          	auipc	a0,0x1b7
    80004658:	4ec50513          	addi	a0,a0,1260 # 801bbb40 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    8000467a:	001b7497          	auipc	s1,0x1b7
    8000467e:	4c648493          	addi	s1,s1,1222 # 801bbb40 <log>
  ...
  if(log.outstanding == 0){
    ...
    do_commit = 1;
    log.committing = 1;
    8000469a:	001b7497          	auipc	s1,0x1b7
    8000469e:	4a648493          	addi	s1,s1,1190 # 801bbb40 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    acquire(&log.lock);
    800046b2:	001b7497          	auipc	s1,0x1b7
    800046b6:	48e48493          	addi	s1,s1,1166 # 801bbb40 <log>
    ...
    wakeup(&log);
    800046e4:	001b7497          	auipc	s1,0x1b7
    800046e8:	45c48493          	addi	s1,s1,1116 # 801bbb40 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    8000470a:	001b7a97          	auipc	s5,0x1b7
    8000470e:	466a8a93          	addi	s5,s5,1126 # 801bbb70 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80004712:	001b7a17          	auipc	s4,0x1b7
    80004716:	42ea0a13          	addi	s4,s4,1070 # 801bbb40 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    log.lh.n = 0;
    80004774:	001b7797          	auipc	a5,0x1b7
    80004778:	3e07ac23          	sw	zero,1016(a5) # 801bbb6c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    80004796:	001b7917          	auipc	s2,0x1b7
    8000479a:	3aa90913          	addi	s2,s2,938 # 801bbb40 <log>
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    ...
    800047ae:	001b7797          	auipc	a5,0x1b7
    800047b2:	3ae7a783          	lw	a5,942(a5) # 801bbb5c <log+0x1c>
    800047b6:	37fd                	addiw	a5,a5,-1
    800047b8:	04f65c63          	bge	a2,a5,80004810 <log_write+0x88>
    panic("too big a transaction");
  if (log.outstanding < 1)
    800047bc:	001b7797          	auipc	a5,0x1b7
    800047c0:	3a47a783          	lw	a5,932(a5) # 801bbb60 <log+0x20>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800047d0:	001b7717          	auipc	a4,0x1b7
    800047d4:	3a070713          	addi	a4,a4,928 # 801bbb70 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    800047ec:	001b7797          	auipc	a5,0x1b7
    800047f0:	35478793          	addi	a5,a5,852 # 801bbb40 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    log.lh.n++;
    80004800:	001b7717          	auipc	a4,0x1b7
    80004804:	34070713          	addi	a4,a4,832 # 801bbb40 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    8000482e:	001b7717          	auipc	a4,0x1b7
    80004832:	31270713          	addi	a4,a4,786 # 801bbb40 <log>
  ...
  release(&log.lock);
    80004840:	001b7517          	auipc	a0,0x1b7
    80004844:	30050513          	addi	a0,a0,768 # 801bbb40 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80004966:	001b7517          	auipc	a0,0x1b7
    8000496a:	32250513          	addi	a0,a0,802 # 801bbc88 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    80004984:	001b7517          	auipc	a0,0x1b7
    80004988:	30450513          	addi	a0,a0,772 # 801bbc88 <ftable>
    8000498c:	accfc0ef          	jal	80000c58 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80004990:	001b7497          	auipc	s1,0x1b7
    80004994:	31048493          	addi	s1,s1,784 # 801bbca0 <ftable+0x18>
    80004998:	001b8717          	auipc	a4,0x1b8
    8000499c:	2a870713          	addi	a4,a4,680 # 801bcc40 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    800049ac:	001b7517          	auipc	a0,0x1b7
    800049b0:	2dc50513          	addi	a0,a0,732 # 801bbc88 <ftable>
  ...
  return 0;
    ...
    800049be:	c0dc                	sw	a5,4(s1)
      release(&ftable.lock);
    800049c0:	001b7517          	auipc	a0,0x1b7
    800049c4:	2c850513          	addi	a0,a0,712 # 801bbc88 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    800049e4:	001b7517          	auipc	a0,0x1b7
    800049e8:	2a450513          	addi	a0,a0,676 # 801bbc88 <ftable>
  ...
  release(&ftable.lock);
    800049fa:	001b7517          	auipc	a0,0x1b7
    800049fe:	28e50513          	addi	a0,a0,654 # 801bbc88 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    80004a2a:	001b7517          	auipc	a0,0x1b7
    80004a2e:	25e50513          	addi	a0,a0,606 # 801bbc88 <ftable>
  ...
  release(&ftable.lock);
    80004a68:	001b7517          	auipc	a0,0x1b7
    80004a6c:	22050513          	addi	a0,a0,544 # 801bbc88 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    release(&ftable.lock);
    80004aa0:	001b7517          	auipc	a0,0x1b7
    80004aa4:	1e850513          	addi	a0,a0,488 # 801bbc88 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80004bc2:	001b7717          	auipc	a4,0x1b7
    80004bc6:	02670713          	addi	a4,a4,38 # 801bbbe8 <devsw>
    ...
    80004c00:	10078b63          	beqz	a5,80004d16 <filewrite+0x11a>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80004c64:	001b7717          	auipc	a4,0x1b7
    80004c68:	f8470713          	addi	a4,a4,-124 # 801bbbe8 <devsw>
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  ustack[argc] = 0;
    ...
    80005278:	f9078793          	addi	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7fe42210>
...
free_desc(int i)
{
  ...
  if(i >= NUM)
    ...
    panic("free_desc 1");
  if(disk.free[i])
    80005e90:	001b7797          	auipc	a5,0x1b7
    80005e94:	db078793          	addi	a5,a5,-592 # 801bcc40 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80005ea4:	001b7797          	auipc	a5,0x1b7
    80005ea8:	d9c78793          	addi	a5,a5,-612 # 801bcc40 <disk>
  ...
  wakeup(&disk.free[0]);
    80005ecc:	001b7517          	auipc	a0,0x1b7
    80005ed0:	d8c50513          	addi	a0,a0,-628 # 801bcc58 <disk+0x18>
...
0000000080005ef8 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005f0c:	001b7517          	auipc	a0,0x1b7
    80005f10:	e5c50513          	addi	a0,a0,-420 # 801bcd68 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80005f78:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47e419df>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80005fca:	001b7497          	auipc	s1,0x1b7
    80005fce:	c7648493          	addi	s1,s1,-906 # 801bcc40 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80005fe8:	001b7717          	auipc	a4,0x1b7
    80005fec:	c6073703          	ld	a4,-928(a4) # 801bcc48 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    80006000:	001b7497          	auipc	s1,0x1b7
    80006004:	c4048493          	addi	s1,s1,-960 # 801bcc40 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    8000611c:	001b7517          	auipc	a0,0x1b7
    80006120:	c4c50513          	addi	a0,a0,-948 # 801bcd68 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    8000612a:	44a1                	li	s1,8
      disk.free[i] = 0;
    8000612c:	001b7b17          	auipc	s6,0x1b7
    80006130:	b14b0b13          	addi	s6,s6,-1260 # 801bcc40 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80006136:	001b7c17          	auipc	s8,0x1b7
    8000613a:	c32c0c13          	addi	s8,s8,-974 # 801bcd68 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    80006158:	001b7717          	auipc	a4,0x1b7
    8000615c:	ae870713          	addi	a4,a4,-1304 # 801bcc40 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80006190:	001b7517          	auipc	a0,0x1b7
    80006194:	ac850513          	addi	a0,a0,-1336 # 801bcc58 <disk+0x18>
  ...
  if(write)
    800061ac:	001b7797          	auipc	a5,0x1b7
    800061b0:	a9478793          	addi	a5,a5,-1388 # 801bcc40 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006282:	001b7917          	auipc	s2,0x1b7
    80006286:	ae690913          	addi	s2,s2,-1306 # 801bcd68 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800062aa:	001b7797          	auipc	a5,0x1b7
    800062ae:	99678793          	addi	a5,a5,-1642 # 801bcc40 <disk>
    800062b2:	97ba                	add	a5,a5,a4
    800062b4:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    800062b8:	001b7997          	auipc	s3,0x1b7
    800062bc:	98898993          	addi	s3,s3,-1656 # 801bcc40 <disk>
  ...
  release(&disk.vdisk_lock);
    800062dc:	001b7517          	auipc	a0,0x1b7
    800062e0:	a8c50513          	addi	a0,a0,-1396 # 801bcd68 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    8000630c:	001b7497          	auipc	s1,0x1b7
    80006310:	93448493          	addi	s1,s1,-1740 # 801bcc40 <disk>
    80006314:	001b7517          	auipc	a0,0x1b7
    80006318:	a5450513          	addi	a0,a0,-1452 # 801bcd68 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    80006388:	001b7517          	auipc	a0,0x1b7
    8000638c:	9e050513          	addi	a0,a0,-1568 # 801bcd68 <disk+0x128>
