...
main(int argc, char *argv[])
{
  ...
  int msqid = msgget(KEY, O_CREATE | 0666);
    ...
    1036:	03950513          	addi	a0,a0,57 # 3039 <base+0xbd9>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    177a:	cda7b783          	ld	a5,-806(a5) # 2450 <freep>
    ...
    17a2:	00e6ea63          	bltu	a3,a4,17b6 <free+0x4a>
{
  ...
  freep = p;
    ...
    17e4:	c6f73823          	sd	a5,-912(a4) # 2450 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    180e:	c4653503          	ld	a0,-954(a0) # 2450 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    183e:	c1690913          	addi	s2,s2,-1002 # 2450 <freep>
  if(p == (char*)-1)
    1842:	5afd                	li	s5,-1
    ...
    1852:	c1278793          	addi	a5,a5,-1006 # 2460 <base>
    1856:	00001717          	auipc	a4,0x1
    185a:	bef73d23          	sd	a5,-1030(a4) # 2450 <freep>
  ...
  if(p == (char*)-1)
    ...
    18c8:	b8a73623          	sd	a0,-1140(a4) # 2450 <freep>
      return (void*)(p + 1);
