...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    1332:	60a98993          	addi	s3,s3,1546 # 3938 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    1394:	5a898993          	addi	s3,s3,1448 # 3938 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    13fc:	54098993          	addi	s3,s3,1344 # 3938 <whitespace>
    1400:	00002a97          	auipc	s5,0x2
    1404:	530a8a93          	addi	s5,s5,1328 # 3930 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    146a:	4d298993          	addi	s3,s3,1234 # 3938 <whitespace>
...
00000000000018c2 <main>:
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    18f4:	06048493          	addi	s1,s1,96 # 3950 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    193c:	018a0a13          	addi	s4,s4,24 # 3950 <buf.0>
    1940:	8552                	mv	a0,s4
    ...
    1980:	fd450513          	addi	a0,a0,-44 # 3950 <buf.0>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    2098:	00002797          	auipc	a5,0x2
    209c:	8a87b783          	ld	a5,-1880(a5) # 3940 <freep>
    ...
    20c4:	00e6ea63          	bltu	a3,a4,20d8 <free+0x4a>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    2102:	00002717          	auipc	a4,0x2
    2106:	82f73f23          	sd	a5,-1986(a4) # 3940 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    212c:	00002517          	auipc	a0,0x2
    2130:	81453503          	ld	a0,-2028(a0) # 3940 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    2160:	7e490913          	addi	s2,s2,2020 # 3940 <freep>
  if(p == (char*)-1)
    2164:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    2170:	00002797          	auipc	a5,0x2
    2174:	84878793          	addi	a5,a5,-1976 # 39b8 <base>
    2178:	00001717          	auipc	a4,0x1
    217c:	7cf73423          	sd	a5,1992(a4) # 3940 <freep>
  ...
  if(p == (char*)-1)
    ...
    21ea:	74a73d23          	sd	a0,1882(a4) # 3940 <freep>
      return (void*)(p + 1);
