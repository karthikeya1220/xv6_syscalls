...
cat(int fd)
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0) {
    ...
    1014:	49090913          	addi	s2,s2,1168 # 24a0 <buf>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    17f4:	ca07b783          	ld	a5,-864(a5) # 2490 <freep>
    ...
    181c:	00e6ea63          	bltu	a3,a4,1830 <free+0x4a>
{
  ...
  freep = p;
    ...
    185e:	c2f73b23          	sd	a5,-970(a4) # 2490 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1888:	c0c53503          	ld	a0,-1012(a0) # 2490 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    18b4:	00001917          	auipc	s2,0x1
    18b8:	bdc90913          	addi	s2,s2,-1060 # 2490 <freep>
  if(p == (char*)-1)
    18bc:	5afd                	li	s5,-1
    ...
    18cc:	dd878793          	addi	a5,a5,-552 # 26a0 <base>
    18d0:	00001717          	auipc	a4,0x1
    18d4:	bcf73023          	sd	a5,-1088(a4) # 2490 <freep>
  ...
  if(p == (char*)-1)
    ...
    193a:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    193e:	00001717          	auipc	a4,0x1
    1942:	b4a73923          	sd	a0,-1198(a4) # 2490 <freep>
      return (void*)(p + 1);
