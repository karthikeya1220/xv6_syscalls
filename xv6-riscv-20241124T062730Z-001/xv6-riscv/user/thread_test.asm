...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    17d6:	cee7b783          	ld	a5,-786(a5) # 24c0 <freep>
    ...
    17fe:	00e6ea63          	bltu	a3,a4,1812 <free+0x4a>
{
  ...
  freep = p;
    ...
    1840:	c8f73223          	sd	a5,-892(a4) # 24c0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    186a:	c5a53503          	ld	a0,-934(a0) # 24c0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    189a:	c2a90913          	addi	s2,s2,-982 # 24c0 <freep>
  if(p == (char*)-1)
    189e:	5afd                	li	s5,-1
    ...
    18ae:	c2678793          	addi	a5,a5,-986 # 24d0 <base>
    18b2:	00001717          	auipc	a4,0x1
    18b6:	c0f73723          	sd	a5,-1010(a4) # 24c0 <freep>
  ...
  if(p == (char*)-1)
    ...
    191c:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1920:	00001717          	auipc	a4,0x1
    1924:	baa73023          	sd	a0,-1120(a4) # 24c0 <freep>
      return (void*)(p + 1);
