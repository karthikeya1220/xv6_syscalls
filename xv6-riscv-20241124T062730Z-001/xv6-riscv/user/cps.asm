...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    172a:	cea7b783          	ld	a5,-790(a5) # 2410 <freep>
    ...
    1752:	00e6ea63          	bltu	a3,a4,1766 <free+0x4a>
{
  ...
  freep = p;
    ...
    1794:	c8f73023          	sd	a5,-896(a4) # 2410 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    17be:	c5653503          	ld	a0,-938(a0) # 2410 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    17ee:	c2690913          	addi	s2,s2,-986 # 2410 <freep>
  if(p == (char*)-1)
    17f2:	5afd                	li	s5,-1
    ...
    1802:	c2278793          	addi	a5,a5,-990 # 2420 <base>
    1806:	00001717          	auipc	a4,0x1
    180a:	c0f73523          	sd	a5,-1014(a4) # 2410 <freep>
  ...
  if(p == (char*)-1)
    ...
    1878:	b8a73e23          	sd	a0,-1124(a4) # 2410 <freep>
      return (void*)(p + 1);
