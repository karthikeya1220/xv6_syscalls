...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    17e2:	c627b783          	ld	a5,-926(a5) # 2440 <freep>
    ...
    180a:	00e6ea63          	bltu	a3,a4,181e <free+0x4a>
{
  ...
  freep = p;
    ...
    184c:	bef73c23          	sd	a5,-1032(a4) # 2440 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1876:	bce53503          	ld	a0,-1074(a0) # 2440 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    18a2:	00001917          	auipc	s2,0x1
    18a6:	b9e90913          	addi	s2,s2,-1122 # 2440 <freep>
  if(p == (char*)-1)
    18aa:	5afd                	li	s5,-1
    ...
    18ba:	b9a78793          	addi	a5,a5,-1126 # 2450 <base>
    18be:	00001717          	auipc	a4,0x1
    18c2:	b8f73123          	sd	a5,-1150(a4) # 2440 <freep>
  ...
  if(p == (char*)-1)
    ...
    1928:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    192c:	00001717          	auipc	a4,0x1
    1930:	b0a73a23          	sd	a0,-1260(a4) # 2440 <freep>
      return (void*)(p + 1);
