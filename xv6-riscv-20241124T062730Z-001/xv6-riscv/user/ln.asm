...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1758:	cec7b783          	ld	a5,-788(a5) # 2440 <freep>
    ...
    1780:	00e6ea63          	bltu	a3,a4,1794 <free+0x4a>
{
  ...
  freep = p;
    ...
    17c2:	c8f73123          	sd	a5,-894(a4) # 2440 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    17ec:	c5853503          	ld	a0,-936(a0) # 2440 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    181c:	c2890913          	addi	s2,s2,-984 # 2440 <freep>
  if(p == (char*)-1)
    1820:	5afd                	li	s5,-1
    ...
    1830:	c2478793          	addi	a5,a5,-988 # 2450 <base>
    1834:	00001717          	auipc	a4,0x1
    1838:	c0f73623          	sd	a5,-1012(a4) # 2440 <freep>
  ...
  if(p == (char*)-1)
    ...
    18a6:	b8a73f23          	sd	a0,-1122(a4) # 2440 <freep>
      return (void*)(p + 1);
