...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1770:	cd47b783          	ld	a5,-812(a5) # 2440 <freep>
    ...
    1798:	00e6ea63          	bltu	a3,a4,17ac <free+0x4a>
{
  ...
  freep = p;
    ...
    17da:	c6f73523          	sd	a5,-918(a4) # 2440 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1804:	c4053503          	ld	a0,-960(a0) # 2440 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1834:	c1090913          	addi	s2,s2,-1008 # 2440 <freep>
  if(p == (char*)-1)
    1838:	5afd                	li	s5,-1
    ...
    1848:	c0c78793          	addi	a5,a5,-1012 # 2450 <base>
    184c:	00001717          	auipc	a4,0x1
    1850:	bef73a23          	sd	a5,-1036(a4) # 2440 <freep>
  ...
  if(p == (char*)-1)
    ...
    18b6:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    18ba:	00001717          	auipc	a4,0x1
    18be:	b8a73323          	sd	a0,-1146(a4) # 2440 <freep>
      return (void*)(p + 1);
