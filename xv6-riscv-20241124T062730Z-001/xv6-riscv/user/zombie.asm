...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1728:	cdc7b783          	ld	a5,-804(a5) # 2400 <freep>
    ...
    1750:	00e6ea63          	bltu	a3,a4,1764 <free+0x4a>
{
  ...
  freep = p;
    ...
    1792:	c6f73923          	sd	a5,-910(a4) # 2400 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    17bc:	c4853503          	ld	a0,-952(a0) # 2400 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    17ec:	c1890913          	addi	s2,s2,-1000 # 2400 <freep>
  if(p == (char*)-1)
    17f0:	5afd                	li	s5,-1
    ...
    1800:	c1478793          	addi	a5,a5,-1004 # 2410 <base>
    1804:	00001717          	auipc	a4,0x1
    1808:	bef73e23          	sd	a5,-1028(a4) # 2400 <freep>
  ...
  if(p == (char*)-1)
    ...
    186e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1872:	00001717          	auipc	a4,0x1
    1876:	b8a73723          	sd	a0,-1138(a4) # 2400 <freep>
      return (void*)(p + 1);
