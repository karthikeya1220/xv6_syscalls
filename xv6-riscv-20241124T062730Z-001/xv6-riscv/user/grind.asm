 ...
 */
    ...
    1018:	31d68693          	addi	a3,a3,797 # 1f31d <base+0x1b6f5>
    101c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
    1020:	6611                	lui	a2,0x4
    1022:	1a760613          	addi	a2,a2,423 # 41a7 <base+0x57f>
    1026:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
    102a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
    102e:	76fd                	lui	a3,0xfffff
    1030:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <base+0xffffffffffffb8c4>
...
rand(void)
{
    ...
    1064:	7c050513          	addi	a0,a0,1984 # 3820 <rand_next>
...
go(int which_child)
{
  ...
  int fd = -1;
    ...
    11de:	66658593          	addi	a1,a1,1638 # 3840 <buf.0>
    11e2:	8552                	mv	a0,s4
    ...
    11f2:	65258593          	addi	a1,a1,1618 # 3840 <buf.0>
    11f6:	8552                	mv	a0,s4
...
iter()
{
  ...
  if(pid1 == 0){
    ...
    1816:	00e70713          	addi	a4,a4,14 # 3820 <rand_next>
  ...
  if(pid2 == 0){
    ...
    1850:	fd468693          	addi	a3,a3,-44 # 3820 <rand_next>
...
main()
{
    ...
    18bc:	f6848493          	addi	s1,s1,-152 # 3820 <rand_next>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1fea:	00002797          	auipc	a5,0x2
    1fee:	8467b783          	ld	a5,-1978(a5) # 3830 <freep>
    ...
    2016:	00e6ea63          	bltu	a3,a4,202a <free+0x4a>
{
  ...
  freep = p;
    ...
    2058:	7cf73e23          	sd	a5,2012(a4) # 3830 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    2082:	7b253503          	ld	a0,1970(a0) # 3830 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    20b2:	78290913          	addi	s2,s2,1922 # 3830 <freep>
  if(p == (char*)-1)
    20b6:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    20c2:	00002797          	auipc	a5,0x2
    20c6:	b6678793          	addi	a5,a5,-1178 # 3c28 <base>
    20ca:	00001717          	auipc	a4,0x1
    20ce:	76f73323          	sd	a5,1894(a4) # 3830 <freep>
  ...
  if(p == (char*)-1)
    ...
    213c:	6ea73c23          	sd	a0,1784(a4) # 3830 <freep>
      return (void*)(p + 1);
