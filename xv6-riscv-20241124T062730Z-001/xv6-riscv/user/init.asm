...
main(void)
{
  ...
  for(;;){
    ...
    109a:	3ea58593          	addi	a1,a1,1002 # 2480 <argv>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    17c6:	cce7b783          	ld	a5,-818(a5) # 2490 <freep>
    ...
    17ee:	00e6ea63          	bltu	a3,a4,1802 <free+0x4a>
{
  ...
  freep = p;
    ...
    1830:	c6f73223          	sd	a5,-924(a4) # 2490 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    185a:	c3a53503          	ld	a0,-966(a0) # 2490 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    188a:	c0a90913          	addi	s2,s2,-1014 # 2490 <freep>
  if(p == (char*)-1)
    188e:	5afd                	li	s5,-1
    ...
    189e:	c0678793          	addi	a5,a5,-1018 # 24a0 <base>
    18a2:	00001717          	auipc	a4,0x1
    18a6:	bef73723          	sd	a5,-1042(a4) # 2490 <freep>
  ...
  if(p == (char*)-1)
    ...
    190c:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1910:	00001717          	auipc	a4,0x1
    1914:	b8a73023          	sd	a0,-1152(a4) # 2490 <freep>
      return (void*)(p + 1);
