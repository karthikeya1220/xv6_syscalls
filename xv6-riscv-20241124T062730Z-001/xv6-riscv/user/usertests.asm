...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    1078:	0000b797          	auipc	a5,0xb
    107c:	ce078793          	addi	a5,a5,-800 # bd58 <uninit>
    1080:	0000d697          	auipc	a3,0xd
    1084:	3e868693          	addi	a3,a3,1000 # e468 <buf>
    if(uninit[i] != '\0'){
...
000000000000122c <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    125c:	0000da17          	auipc	s4,0xd
    1260:	20ca0a13          	addi	s4,s4,524 # e468 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
...
000000000000187e <writetest>:
{
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    1904:	0000d597          	auipc	a1,0xd
    1908:	b6458593          	addi	a1,a1,-1180 # e468 <buf>
...
00000000000019be <writebig>:
{
  ...
  for(i = 0; i < MAXFILE; i++){
    19e4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
    19e6:	0000d917          	auipc	s2,0xd
    19ea:	a8290913          	addi	s2,s2,-1406 # e468 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  n = 0;
    1a2a:	4481                	li	s1,0
    i = read(fd, buf, BSIZE);
    1a2c:	0000d917          	auipc	s2,0xd
    1a30:	a3c90913          	addi	s2,s2,-1476 # e468 <buf>
  if(fd < 0){
...
0000000000001b1e <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    1ba2:	0000d597          	auipc	a1,0xd
    1ba6:	8c658593          	addi	a1,a1,-1850 # e468 <buf>
    1baa:	8526                	mv	a0,s1
    1bac:	6ed030ef          	jal	5a98 <read>
    1bb0:	4795                	li	a5,5
    1bb2:	08f51363          	bne	a0,a5,1c38 <unlinkread+0x11a>
  if(buf[0] != 'h'){
    1bb6:	0000d717          	auipc	a4,0xd
    1bba:	8b274703          	lbu	a4,-1870(a4) # e468 <buf>
    1bbe:	06800793          	li	a5,104
    1bc2:	08f71563          	bne	a4,a5,1c4c <unlinkread+0x12e>
  if(write(fd, buf, 10) != 10){
    1bc6:	4629                	li	a2,10
    1bc8:	0000d597          	auipc	a1,0xd
    1bcc:	8a058593          	addi	a1,a1,-1888 # e468 <buf>
    1bd0:	8526                	mv	a0,s1
...
0000000000001c74 <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    1d16:	0000c597          	auipc	a1,0xc
    1d1a:	75258593          	addi	a1,a1,1874 # e468 <buf>
...
0000000000001fd4 <pgbug>:
{
  ...
  exec(big, argv);
    1fe2:	00009497          	auipc	s1,0x9
    1fe6:	80e48493          	addi	s1,s1,-2034 # a7f0 <big>
...
0000000000002000 <badarg>:
{
    ...
    2010:	35048493          	addi	s1,s1,848 # c350 <uninit+0x5f8>
...
000000000000203e <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    20be:	00009797          	auipc	a5,0x9
    20c2:	c9278793          	addi	a5,a5,-878 # ad50 <big.0>
    20c6:	0000a697          	auipc	a3,0xa
    20ca:	c8a68693          	addi	a3,a3,-886 # bd50 <big.0+0x1000>
      big[i] = 'x';
    ...
    big[PGSIZE] = '\0';
    20dc:	0000a797          	auipc	a5,0xa
    20e0:	c6078a23          	sb	zero,-908(a5) # bd50 <big.0+0x1000>
...
00000000000024b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    24ec:	0000ca97          	auipc	s5,0xc
    24f0:	f7ca8a93          	addi	s5,s5,-132 # e468 <buf>
    24f4:	864a                	mv	a2,s2
    24f6:	85d6                	mv	a1,s5
    ...
    2500:	0ea05a63          	blez	a0,25f4 <pipe1+0x140>
      for(i = 0; i < n; i++){
    2504:	0000c717          	auipc	a4,0xc
    2508:	f6470713          	addi	a4,a4,-156 # e468 <buf>
    ...
    for(n = 0; n < N; n++){
    256a:	0000cb17          	auipc	s6,0xc
    256e:	efeb0b13          	addi	s6,s6,-258 # e468 <buf>
...
0000000000002a08 <linkunlink>:
{
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2a4a:	e6da0a1b          	addiw	s4,s4,-403 # 41c64e6d <base+0x41c53a05>
...
0000000000002b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2ba8:	35098993          	addi	s3,s3,848 # c350 <uninit+0x5f8>
    2bac:	1003d937          	lui	s2,0x1003d
    2bb0:	090e                	slli	s2,s2,0x3
    2bb2:	48090913          	addi	s2,s2,1152 # 1003d480 <base+0x1002c018>
    pid = fork();
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2ce0:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <base+0xfffffffffffedb98>
    2ce4:	85a6                	mv	a1,s1
...
0000000000002db6 <manywrites>:
{
  ...
  exit(0);
    ...
    2e3e:	4bf9                	li	s7,30
          int cc = write(fd, buf, sz);
    2e40:	0000bb17          	auipc	s6,0xb
    2e44:	628b0b13          	addi	s6,s6,1576 # e468 <buf>
...
00000000000030d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    3108:	6705                	lui	a4,0x1
      *b = 99;
    310a:	00d50023          	sb	a3,0(a0) # 40000000 <base+0x3ffeeb98>
    for(b = a; b < a+TOOMUCH; b += 4096){
...
0000000000003216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    3268:	fee78fa3          	sb	a4,-1(a5) # 63fffff <base+0x63eeb97>
  a = sbrk(0);
    326c:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    32b4:	fff7c703          	lbu	a4,-1(a5) # 63fffff <base+0x63eeb97>
...
000000000000346c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    34f2:	8007879b          	addiw	a5,a5,-2048 # a800 <quicktests>
...
00000000000035ca <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    35d6:	0511                	addi	a0,a0,4 # ffffffff80000004 <base+0xffffffff7ffeeb9c>
...
0000000000003bdc <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3c90:	0000a597          	auipc	a1,0xa
    3c94:	7d858593          	addi	a1,a1,2008 # e468 <buf>
    3c98:	601010ef          	jal	5a98 <read>
  if(cc != 2 || buf[0] != 'f'){
    3c9c:	4789                	li	a5,2
    3c9e:	2cf51063          	bne	a0,a5,3f5e <subdir+0x382>
    3ca2:	0000a717          	auipc	a4,0xa
    3ca6:	7c674703          	lbu	a4,1990(a4) # e468 <buf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    3d48:	0000a597          	auipc	a1,0xa
    3d4c:	72058593          	addi	a1,a1,1824 # e468 <buf>
...
0000000000004764 <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4826:	0000a597          	auipc	a1,0xa
    482a:	c4258593          	addi	a1,a1,-958 # e468 <buf>
...
0000000000004920 <sbrkfail>:
{
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4a50:	6705                	lui	a4,0x1
      n += *(a+i);
    4a52:	0007c683          	lbu	a3,0(a5) # 6400000 <base+0x63eeb98>
...
0000000000004c5e <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
    4cee:	00009a17          	auipc	s4,0x9
    4cf2:	77aa0a13          	addi	s4,s4,1914 # e468 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d2e:	00009517          	auipc	a0,0x9
    4d32:	73a50513          	addi	a0,a0,1850 # e468 <buf>
    4d36:	365000ef          	jal	589a <memset>
    4d3a:	44b1                	li	s1,12
        if((n = write(fd, buf, SZ)) != SZ){
    4d3c:	00009997          	auipc	s3,0x9
    4d40:	72c98993          	addi	s3,s3,1836 # e468 <buf>
    ...
    4db6:	00009797          	auipc	a5,0x9
    4dba:	6b278793          	addi	a5,a5,1714 # e468 <buf>
...
00000000000050d6 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    5108:	4481                	li	s1,0
    memset(buf, i, SZ);
    510a:	00009917          	auipc	s2,0x9
    510e:	35e90913          	addi	s2,s2,862 # e468 <buf>
  for(i = 0; i < N; i++){
    5112:	4a51                	li	s4,20
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    5156:	4481                	li	s1,0
    cc = read(fd, buf, SZ/2);
    5158:	00009917          	auipc	s2,0x9
    515c:	31090913          	addi	s2,s2,784 # e468 <buf>
  if(fd < 0){
...
000000000000525a <bigargtest>:
{
  ...
  close(fd);
    ...
    52be:	00006797          	auipc	a5,0x6
    52c2:	99278793          	addi	a5,a5,-1646 # ac50 <args.1>
    52c6:	00006697          	auipc	a3,0x6
    52ca:	a8268693          	addi	a3,a3,-1406 # ad48 <args.1+0xf8>
      args[i] = big;
    ...
    args[MAXARG-1] = 0;
    52da:	00006597          	auipc	a1,0x6
    52de:	97658593          	addi	a1,a1,-1674 # ac50 <args.1>
...
0000000000005338 <fsfull>:
{
  ...
  printf("fsfull test finished\n");
    ...
    5470:	00009a97          	auipc	s5,0x9
    5474:	ff8a8a93          	addi	s5,s5,-8 # e468 <buf>
      if(cc < BSIZE)
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    56c6:	00005b17          	auipc	s6,0x5
    56ca:	13ab0b13          	addi	s6,s6,314 # a800 <quicktests>
      if(continuous != 2) {
    56ce:	4a09                	li	s4,2
      }
    }
    ...
    56d0:	00005c17          	auipc	s8,0x5
    56d4:	500c0c13          	addi	s8,s8,1280 # abd0 <slowtests>
        printf("usertests slow tests starting\n");
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5f1c:	00005797          	auipc	a5,0x5
    5f20:	d247b783          	ld	a5,-732(a5) # ac40 <freep>
    ...
    5f48:	00e6ea63          	bltu	a3,a4,5f5c <free+0x4a>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    5f86:	00005717          	auipc	a4,0x5
    5f8a:	caf73d23          	sd	a5,-838(a4) # ac40 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    5fb0:	00005517          	auipc	a0,0x5
    5fb4:	c9053503          	ld	a0,-880(a0) # ac40 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    5fe0:	00005917          	auipc	s2,0x5
    5fe4:	c6090913          	addi	s2,s2,-928 # ac40 <freep>
  if(p == (char*)-1)
    5fe8:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    5ff4:	0000b797          	auipc	a5,0xb
    5ff8:	47478793          	addi	a5,a5,1140 # 11468 <base>
    5ffc:	00005717          	auipc	a4,0x5
    6000:	c4f73223          	sd	a5,-956(a4) # ac40 <freep>
  ...
  if(p == (char*)-1)
    ...
    6066:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    606a:	00005717          	auipc	a4,0x5
    606e:	bca73b23          	sd	a0,-1066(a4) # ac40 <freep>
      return (void*)(p + 1);
