...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    175e:	cc67b783          	ld	a5,-826(a5) # 2420 <freep>
    ...
    1786:	00e6ea63          	bltu	a3,a4,179a <free+0x4a>
{
  ...
  freep = p;
    ...
    17c8:	c4f73e23          	sd	a5,-932(a4) # 2420 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    17f2:	c3253503          	ld	a0,-974(a0) # 2420 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1822:	c0290913          	addi	s2,s2,-1022 # 2420 <freep>
  if(p == (char*)-1)
    1826:	5afd                	li	s5,-1
    ...
    1836:	bfe78793          	addi	a5,a5,-1026 # 2430 <base>
    183a:	00001717          	auipc	a4,0x1
    183e:	bef73323          	sd	a5,-1050(a4) # 2420 <freep>
  ...
  if(p == (char*)-1)
    ...
    18ac:	b6a73c23          	sd	a0,-1160(a4) # 2420 <freep>
      return (void*)(p + 1);
