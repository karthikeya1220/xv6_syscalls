...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1752:	d327b783          	ld	a5,-718(a5) # 2480 <freep>
    ...
    177a:	00e6ea63          	bltu	a3,a4,178e <free+0x4a>
{
  ...
  freep = p;
    ...
    17bc:	ccf73423          	sd	a5,-824(a4) # 2480 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    17e6:	c9e53503          	ld	a0,-866(a0) # 2480 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1816:	c6e90913          	addi	s2,s2,-914 # 2480 <freep>
  if(p == (char*)-1)
    181a:	5afd                	li	s5,-1
    ...
    182a:	c6a78793          	addi	a5,a5,-918 # 2490 <base>
    182e:	00001717          	auipc	a4,0x1
    1832:	c4f73923          	sd	a5,-942(a4) # 2480 <freep>
  ...
  if(p == (char*)-1)
    ...
    18a0:	bea73223          	sd	a0,-1052(a4) # 2480 <freep>
      return (void*)(p + 1);
