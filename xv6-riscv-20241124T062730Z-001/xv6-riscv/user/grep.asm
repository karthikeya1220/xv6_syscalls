...
0000000000001106 <grep>:
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
    ...
    112c:	408a8a93          	addi	s5,s5,1032 # 2530 <buf>
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
    ...
    1196:	39e50513          	addi	a0,a0,926 # 2530 <buf>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1964:	bc07b783          	ld	a5,-1088(a5) # 2520 <freep>
    ...
    198c:	00e6ea63          	bltu	a3,a4,19a0 <free+0x4a>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    19ca:	00001717          	auipc	a4,0x1
    19ce:	b4f73b23          	sd	a5,-1194(a4) # 2520 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    19f4:	00001517          	auipc	a0,0x1
    19f8:	b2c53503          	ld	a0,-1236(a0) # 2520 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1a24:	00001917          	auipc	s2,0x1
    1a28:	afc90913          	addi	s2,s2,-1284 # 2520 <freep>
  if(p == (char*)-1)
    1a2c:	5afd                	li	s5,-1
    ...
    1a3c:	ef878793          	addi	a5,a5,-264 # 2930 <base>
    1a40:	00001717          	auipc	a4,0x1
    1a44:	aef73023          	sd	a5,-1312(a4) # 2520 <freep>
  ...
  if(p == (char*)-1)
    ...
    1aaa:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1aae:	00001717          	auipc	a4,0x1
    1ab2:	a6a73923          	sd	a0,-1422(a4) # 2520 <freep>
      return (void*)(p + 1);
