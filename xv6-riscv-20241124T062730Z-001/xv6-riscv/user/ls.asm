...
fmtname(char *path)
{
  ...
  memmove(buf, p, strlen(p));
    ...
    105a:	4aa98993          	addi	s3,s3,1194 # 2500 <buf.0>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    196e:	00001797          	auipc	a5,0x1
    1972:	b827b783          	ld	a5,-1150(a5) # 24f0 <freep>
    ...
    199a:	00e6ea63          	bltu	a3,a4,19ae <free+0x4a>
{
  ...
  freep = p;
    ...
    19dc:	b0f73c23          	sd	a5,-1256(a4) # 24f0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1a06:	aee53503          	ld	a0,-1298(a0) # 24f0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1a32:	00001917          	auipc	s2,0x1
    1a36:	abe90913          	addi	s2,s2,-1346 # 24f0 <freep>
  if(p == (char*)-1)
    1a3a:	5afd                	li	s5,-1
    ...
    1a4a:	aca78793          	addi	a5,a5,-1334 # 2510 <base>
    1a4e:	00001717          	auipc	a4,0x1
    1a52:	aaf73123          	sd	a5,-1374(a4) # 24f0 <freep>
  ...
  if(p == (char*)-1)
    ...
    1ab8:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1abc:	00001717          	auipc	a4,0x1
    1ac0:	a2a73a23          	sd	a0,-1484(a4) # 24f0 <freep>
      return (void*)(p + 1);
