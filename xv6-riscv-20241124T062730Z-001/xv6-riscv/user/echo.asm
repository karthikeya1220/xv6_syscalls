...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1784:	ca07b783          	ld	a5,-864(a5) # 2420 <freep>
    ...
    17ac:	00e6ea63          	bltu	a3,a4,17c0 <free+0x4a>
{
  ...
  freep = p;
    ...
    17ee:	c2f73b23          	sd	a5,-970(a4) # 2420 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1818:	c0c53503          	ld	a0,-1012(a0) # 2420 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1844:	00001917          	auipc	s2,0x1
    1848:	bdc90913          	addi	s2,s2,-1060 # 2420 <freep>
  if(p == (char*)-1)
    184c:	5afd                	li	s5,-1
    ...
    185c:	bd878793          	addi	a5,a5,-1064 # 2430 <base>
    1860:	00001717          	auipc	a4,0x1
    1864:	bcf73023          	sd	a5,-1088(a4) # 2420 <freep>
  ...
  if(p == (char*)-1)
    ...
    18d2:	b4a73923          	sd	a0,-1198(a4) # 2420 <freep>
      return (void*)(p + 1);
